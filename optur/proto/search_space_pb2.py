...
_DISTRIBUTION_UNKNOWNDISTRIBUTION = _descriptor.Descriptor(
    name="UnknownDistribution",
    full_name="optur.Distribution.UnknownDistribution",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    create_key=_descriptor._internal_create_key,
    fields=[
        _descriptor.FieldDescriptor(
            name="values",
            full_name="optur.Distribution.UnknownDistribution.values",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_DISTRIBUTION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="optur.Distribution.unknown_distribution",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
    ...
    nested_types=[
        ...
        _DISTRIBUTION_UNKNOWNDISTRIBUTION,
    ],
    enum_types=[],
    serialized_options=None,
    is_extendable=False,
...
_DISTRIBUTION_UNKNOWNDISTRIBUTION.fields_by_name["values"].message_type = _PARAMETERVALUE
_DISTRIBUTION_UNKNOWNDISTRIBUTION.containing_type = _DISTRIBUTION
_DISTRIBUTION.fields_by_name[
    "unknown_distribution"
].message_type = _DISTRIBUTION_UNKNOWNDISTRIBUTION
...
_DISTRIBUTION.oneofs_by_name["distribution"].fields.append(
    _DISTRIBUTION.fields_by_name["unknown_distribution"]
)
_DISTRIBUTION.fields_by_name[
    "unknown_distribution"
...
Distribution = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "UnknownDistribution": _reflection.GeneratedProtocolMessageType(
            "UnknownDistribution",
            (_message.Message,),
            {
                "DESCRIPTOR": _DISTRIBUTION_UNKNOWNDISTRIBUTION,
                "__module__": "optur.proto.search_space_pb2"
                # @@protoc_insertion_point(class_scope:optur.Distribution.UnknownDistribution)
            },
        ),
...
_sym_db.RegisterMessage(Distribution.UnknownDistribution)
