...
class StudyInfo(google___protobuf___message___Message):
    ...
    def HasField(self, field_name: typing_extensions___Literal[u"create_time",b"create_time",u"last_update_time",b"last_update_time"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"create_time",b"create_time",u"last_update_time",b"last_update_time",u"study_id",b"study_id",u"study_name",b"study_name",u"system_attrs",b"system_attrs",u"targets",b"targets",u"user_attrs",b"user_attrs"]) -> None: ...
...
class Target(google___protobuf___message___Message):
    ...
    class _Direction(google___protobuf___internal___enum_type_wrapper____EnumTypeWrapper[Target.DirectionValue]):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"direction",b"direction",u"name",b"name"]) -> None: ...
...
class Trial(google___protobuf___message___Message):
    ...
    State: _State
    class _State(google___protobuf___internal___enum_type_wrapper____EnumTypeWrapper[Trial.StateValue]):
        DESCRIPTOR: google___protobuf___descriptor___EnumDescriptor = ...
    ...
    @property
    def values(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[type___ObjectiveValue]: ...

    @property
    def reports(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[type___Report]: ...
    ...
    def __init__(self,
        *,
        ...
        create_time : typing___Optional[google___protobuf___timestamp_pb2___Timestamp] = None,
        last_update_time : typing___Optional[google___protobuf___timestamp_pb2___Timestamp] = None,
        distributions : typing___Optional[typing___Mapping[typing___Text, type___Distribution]] = None,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"create_time",b"create_time",u"last_update_time",b"last_update_time",u"worker_id",b"worker_id"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"create_time",b"create_time",u"distributions",b"distributions",u"last_known_state",b"last_known_state",u"last_update_time",b"last_update_time",u"parameters",b"parameters",u"reports",b"reports",u"study_id",b"study_id",u"system_attrs",b"system_attrs",u"trial_id",b"trial_id",u"user_attrs",b"user_attrs",u"values",b"values",u"worker_id",b"worker_id"]) -> None: ...
type___Trial = Trial
...
class WorkerID(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"bucket_id",b"bucket_id",u"client_id",b"client_id",u"thread_id",b"thread_id"]) -> None: ...
...
class Report(google___protobuf___message___Message):
    ...
    def HasField(self, field_name: typing_extensions___Literal[u"event_time",b"event_time"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"event_time",b"event_time",u"step",b"step",u"values",b"values"]) -> None: ...
...
class ObjectiveValue(google___protobuf___message___Message):
    ...
    Status: _Status
    class _Status(google___protobuf___internal___enum_type_wrapper____EnumTypeWrapper[ObjectiveValue.StatusValue]):
        DESCRIPTOR: google___protobuf___descriptor___EnumDescriptor = ...
...
class ParameterValue(google___protobuf___message___Message):
    ...
    def HasField(self, field_name: typing_extensions___Literal[u"double_value",b"double_value",u"int_value",b"int_value",u"string_value",b"string_value",u"value",b"value"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"double_value",b"double_value",u"int_value",b"int_value",u"string_value",b"string_value",u"value",b"value"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"value",b"value"]) -> typing_extensions___Literal["int_value","double_value","string_value"]: ...
...
class Distribution(google___protobuf___message___Message):
    ...
    class FloatDistribution(google___protobuf___message___Message):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"high",b"high",u"log_scale",b"log_scale",u"low",b"low"]) -> None: ...
    ...
    class CategoricalDistribution(google___protobuf___message___Message):
        ...
        @property
        def choices(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[type___ParameterValue]: ...

        def __init__(self,
            *,
            choices : typing___Optional[typing___Iterable[type___ParameterValue]] = None,
            ) -> None: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"choices",b"choices"]) -> None: ...
    ...
    def __init__(self,
        *,
        ...
        categorical_distribution : typing___Optional[type___Distribution.CategoricalDistribution] = None,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"categorical_distribution",b"categorical_distribution",u"distribution",b"distribution",u"float_distribution",b"float_distribution",u"int_distribution",b"int_distribution"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"categorical_distribution",b"categorical_distribution",u"distribution",b"distribution",u"float_distribution",b"float_distribution",u"int_distribution",b"int_distribution"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"distribution",b"distribution"]) -> typing_extensions___Literal["float_distribution","int_distribution","categorical_distribution"]: ...
...
class SearchSpace(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"distributions",b"distributions"]) -> None: ...
